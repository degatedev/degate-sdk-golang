...
type TokenListParam struct {
	Ids     string `json:"ids" form:"ids"`         // 1,2
	Symbols string `json:"symbols" form:"symbols"` // ETH,USDC
}
...
type CancelOrderParamWithTokenId struct {
	...
	EDDSASignature string `json:"eddsa_signature" form:"eddsa_signature" binding:"required"`
	Key            string `json:"-"`
	SellTokenId    uint64 `json:"sell_token_id" form:"sell_token_id" binding:"required"`
	FeeTokenVol    string `json:"fee_token_vol" form:"fee_token_vol" binding:"required"`
	FeeTokenId     uint64 `json:"fee_token_id" form:"fee_token_id" binding:"required"`
}
...
type DGOrderParam struct {
	...
	SellToken        Token  `json:"sell_token" form:"sell_token" binding:"required"`
	BuyToken         Token  `json:"buy_token" form:"buy_token" binding:"required"`
	ValidUntil       int64  `json:"valid_until" form:"valid_until" binding:"required"`
	FeeToken         Token  `json:"fee_token" form:"fee_token" binding:"required"`
	EDDSASignature   string `json:"eddsa_signature" form:"eddsa_signature" binding:"required"`
...
type Token struct {
	...
	Volume  string `json:"volume"  form:"volume" binding:"required"`
}
